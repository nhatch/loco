...
sometimes, an action during one period of the episode can leave the robot in a bad position to achieve the desired result for the next period.
...
\begin{figure}
  \includegraphics[width=0.48\textwidth]{2D_ep.png}
  \includegraphics[width=0.48\textwidth]{3D_ep.png}
